...
### Status legend:
🚧 &ndash; **In progress** &ndash; the board is on hand, the schematic / BOM is planned to be drawn (any help welcome)

🆘 &ndash; **Wanted** &ndash; no board on hand, no document available; a good-quality photo, document or a board donation would help
...
This project is licensed under the **CERN Open Hardware Licence Version 2 - Weakly Reciprocal (CERN-OHL-W)**. See the [LICENSE](LICENSE) file for the full text.
